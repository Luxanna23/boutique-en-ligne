...
--
-- Hôte : localhost:3306
-- Généré le : mer. 21 juin 2023 à 07:31
...
(5, 4, 'Too', 'Toto', 1, 'rue republique', 75001, 'Paris');
...
(4, 'Colliers', 'https://cdn.shopify.com/s/files/1/0509/4116/5720/products/colliers-elegance-or-jardin-des-bijoux-398.webp?v=1683811549&width=934'),
...
CREATE TABLE `commande` (
  ...
  `paymentIntentId` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(8, 'a@a.a', '$2y$10$hOsA02A0CdveyQHb.Oi2quiragLOiXzGqXzK5ECeDNIUfHKj3T86a', 'aaa', 'aaa', 'avatars/default.png', NULL);
