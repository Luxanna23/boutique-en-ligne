...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 06 juil. 2023 à 08:38
...
(1, 'Nouveautés', 'https://www.zoshacollection.com/blog/wp-content/uploads/2022/08/bijoux-acier-inoxydable-1-1024x1024.jpg'),
...
--
ALTER TABLE `articles`
  MODIFY `idArt` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
...
--
ALTER TABLE `categorie`
  MODIFY `idCat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
